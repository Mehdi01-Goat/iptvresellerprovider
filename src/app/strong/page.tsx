...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description:
      "High performance Strong IPTV server. 46,976 live channels, 149K+ movies. Wholesale Strong IPTV panel. Free trial available.",
    images: ["/images/panel-strong-main.png"],
  },
};

const strongFaqs: Faq[] = [
  ...
  { q: "How much money do I need to start with Strong IPTV?", a: "You can start with as little as $290 — our entry-level Strong package with 120 credits. Credits never expire and are fully refundable." },
  { q: "Can I test Strong IPTV before buying credits?", a: "Yes — Strong IPTV comes with a free 24-hour trial. Test stability, channel quality, VOD library, and speed before spending a dollar." },
  ...
  { q: "Are your Strong IPTV prices really wholesale?", a: "Yes. We source directly from the Strong IPTV server with no middlemen. Most resellers mark up 4–6x and still offer competitive prices in their market." },
